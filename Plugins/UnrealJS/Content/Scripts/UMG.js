(function (global) {
    ...
    var UMG = {
        ...
        sw : function (opts, template) {
            ...
            return UMG.base(SizeBox,_.extend({Visibility:'Collapsed'},opts),{
                $link : function (elem, scope, attrs) {
                    var child = null
    ...
    UMG.TabManager = function (opts, children) {
        ...
        return UMG.base(JavascriptEditorTabManager, opts, {
            $link: function (manager, scope) {
                ...
                // @HACK : ?¥Í±¥ style???àÎ°ú ?ùÍ∏¥ control???Ä???ÅÏö©?òÏ? ?äÎäî Î¨∏Ï†ú ?åÎ¨∏??Î∞úÏÉù?òÎäî Í≤ÉÏù∏??..
                // ?¨Ïã§ ??control??extended style??Í∞ñÍ≥† ?Ä??ÏßÅÏ†ë ?ÅÏö©??Ï£ºÎ©¥ ??Í≤?Í∞ôÏäµ?àÎã§.
                var pending_fn = null
