...
### Install and play
- Video tutorial available! (https://www.youtube.com/watch?v=XxPSLjBg7DU)
- Make sure you have [UnrealEngine 4.11.0(Preview 8) canonical build](https://www.unrealengine.com/dashboard).
